...
/**
 * SimpleSettingsInitResource.java
 * 
 * Manages fetching init files for simple settings.
 * 
 * TODO: validate init files against schema
 * 
 * @author carl.scott
 * 
 */
public class SimpleSettingsInitResource extends Resource {

	private final SimpleSettingsWorker worker;

	public SimpleSettingsInitResource(Context context, Request request, Response response) {
