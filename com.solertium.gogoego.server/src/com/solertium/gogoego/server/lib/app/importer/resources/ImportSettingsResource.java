 ...
 *
 */
public class ImportSettingsResource extends Resource {
	
	private final ImporterSettings settings;

	public ImportSettingsResource(Context context, Request request, Response response) {
		super(context, request, response);
		setModifiable(true);
		
		settings = ((ImporterApplication)ServerApplication.
