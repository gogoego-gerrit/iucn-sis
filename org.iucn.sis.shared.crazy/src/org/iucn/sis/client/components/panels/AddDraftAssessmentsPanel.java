...
public class AddDraftAssessmentsPanel extends Dialog {
	...
	// AssessmentData temp = AssessmentCache.impl.getAssessment(tempID,
	// BaseAssessment.DRAFT_ASSESSMENT_STATUS, false);
	// if (temp == null){
	// TaxonNode node = TaxonomyCache.impl.getNode(tempID);
