...
public class WorkingSetOptionsPanel extends RefreshLayoutContainer {
	...
	// private CardLayout stackLayoutInfoPanel = null;
	// private CardLayout stackLayoutTaxaListHolder = null;
	...
	private void addContent(RowData data) {
		...
		// stackLayoutTaxaListHolder = new CardLayout();
		// taxaListHolder.setLayout(stackLayoutTaxaListHolder);
		// taxaListHolder.add(checkedTaxaList);
		// checkedTaxaList.setData("layout", stackLayoutTaxaListHolder);
		// taxaListHolder.add(taxaList);
		// taxaList.setData("layout", stackLayoutInfoPanel);
		// taxaListHolder.add(deleteTaxaList);
		// deleteTaxaList.setData("layout", stackLayoutInfoPanel);
		// stackLayoutTaxaListHolder.setActiveItem(taxaList);
		...
		// stackLayoutInfoPanel = new CardLayout();
		// infoPanel.setLayout(stackLayoutInfoPanel);
		content.add(infoPanel, east);

		// infoPanel.add(manager.addTaxonPanel);
		// manager.addTaxonPanel.setData("layout", stackLayoutInfoPanel);
		// infoPanel.add(browserPanel);
		// browserPanel.setData("layout", stackLayoutInfoPanel);
		// infoPanel.add(deletePanel);
		// deletePanel.setData("layout", stackLayoutInfoPanel);
		// infoPanel.add(movePanel);
		// movePanel.setData("layout", stackLayoutInfoPanel);
		// infoPanel.add(blankPanel);
		// blankPanel.setData("layout", stackLayoutInfoPanel);
		// stackLayoutInfoPanel.setActiveItem(blankPanel);
	...
	public void refreshTaxaList(final boolean editable) {
		...
		if (editable) {
			SysDebugger.getInstance().println("I am editable");
