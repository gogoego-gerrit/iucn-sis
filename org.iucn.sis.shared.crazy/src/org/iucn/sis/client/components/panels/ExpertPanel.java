...
import org.iucn.sis.client.expert.ExpertResult;
import org.iucn.sis.client.expert.FuzzyExpImpl;
...
//		add(messageWrap, southData);
	...
	public void update() {
		...
		AssessmentData assessment = AssessmentCache.impl.getCurrentAssessment();
		expertBar.removeAll();

		range.setText("");

		if (assessment != null) {
			String assessmentName = assessment.getAssessmentID();
