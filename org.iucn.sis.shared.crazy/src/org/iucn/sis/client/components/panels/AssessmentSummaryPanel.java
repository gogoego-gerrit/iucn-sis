...
public class AssessmentSummaryPanel extends TabPanel {
	...
	// private AssessmentData currentAssessment = null;
	...
	// return "N/A";
	// }
	// else if (status.equals(BaseAssessment.DRAFT_ASSESSMENT_STATUS)){
	// return "Draft Assessment";
	// }
	// else if (status.equals(BaseAssessment.PUBLISHED_ASSESSMENT_STATUS)){
	// return "Published Assessment";
	// }
	// else if (status.equals(BaseAssessment.USER_ASSESSMENT_STATUS)){
