...
//		setTopComponent(toolBar);
	...
	private boolean containsModel(Long userID) {
		return permissionGrid.getStore().findModel("id", userID) != null;
	}
	 ...
	 */
	public void draw() {
		final WorkingSetData curWS = WorkingSetCache.impl.getCurrentWorkingSet();
		final User curUser = SimpleSISClient.currentUser;
