...
//		document.put(UriBase.getInstance().getRecentAssessmentsBase() + UserModelTabPanel.CONSTANTS_ATTACHMENT_POINT + "/manager/custom", getXML(),
...
//				});
	...
	private void createBody() {
		...
		type.addClickListener(new ClickListener() {
	...
	private void updateExisting() {
		final NativeDocument document = NativeDocumentFactory.newNativeDocument();
		document.post(UserModelTabPanel.CONSTANTS_ATTACHMENT_POINT + "/manager/custom/" + id, getXML(),
				new GenericCallback<String>() {
					public void onFailure(Throwable caught) {
						WindowUtils.errorAlert("Error", "Could not save, please try again later.");
					}
