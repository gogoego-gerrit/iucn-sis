...
public class CustomFieldViewPanel extends LayoutContainer implements HasRefreshableContent {
			...
			public void componentSelected(ButtonEvent ce) {
				...
				WindowUtils.confirmAlert("Confirm", "Are you sure you want to remove the \"" + selected.get("name")
					...
					public void onYes() {
						...
						document.delete(UserModelTabPanel.CONSTANTS_ATTACHMENT_POINT + "/manager/custom/"
	...
	private void populateStore() {
		center.removeAll();
		final NativeDocument document = NativeDocumentFactory.newNativeDocument();
		document.get(UserModelTabPanel.CONSTANTS_ATTACHMENT_POINT + "/dump/customfield", new GenericCallback<String>() {
			public void onFailure(Throwable caught) {
