...
public class PressButtonGroup {
	...
	private ClickListener pressListener; // Does the swap
	...
	public PressButtonGroup(String defaultStyle, String pressedStyle, Panel displayPanel) {
		...
		pressListener = new ClickListener() {
			public void onClick(Widget sender) {
				buttonPressed((IndexButton) sender);
			}
		};
	}

	public void addNewButton(IndexButton button, String data, ClickListener listener) {
		button.setStyleName(defaultStyle);
		button.setData(data);
		button.addClickListener(pressListener);
		if (listener != null)
	 ...
	 */
	public void addNewButton(String buttonName, String data, ClickListener listener) {
	 ...
	 *            same listener)
	 */
	public void addNewButtonGroup(ArrayList buttonNames, ArrayList data, ClickListener listener) {
