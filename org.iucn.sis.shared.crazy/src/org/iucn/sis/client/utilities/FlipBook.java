...
public class FlipBook {
	...
	private Widget getFooterScroll() {
		...
		prev = new Button("<--", new ClickListener() {
		...
		next = new Button("-->", new ClickListener() {
			public void onClick(Widget sender) {
				if ((((Button) sender).getText().equalsIgnoreCase("-->"))) {
		...
		if (cancelButton == null) {
			footerScroll.add(new Button("Cancel", new ClickListener() {
				public void onClick(Widget sender) {
					closeBook();
				}
			}));
	...
	public void setCancelButton(Button button, ClickListener listener) {
		this.cancelButton = button;
		cancelButton.addClickListener(listener);
	}

	public void setCancelButton(String buttonText, ClickListener listener) {
	 ...
	 */
	public void setFooterButton(Button button, ClickListener listener) {
		this.footerButton = button;
		footerButton.addClickListener(listener);
	}

	/************ PAGE RELATED FUNCTIONS *************/

	public void setFooterButton(String buttonText, ClickListener listener) {
