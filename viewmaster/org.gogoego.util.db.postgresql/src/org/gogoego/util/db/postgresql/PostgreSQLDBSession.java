...
import org.gogoego.util.db.IllegalExecutionLevelException;
import org.gogoego.util.db.shared.CBoolean;
import org.gogoego.util.db.shared.CDate;
import org.gogoego.util.db.shared.CDateTime;
import org.gogoego.util.db.shared.CDouble;
...
import org.gogoego.util.db.shared.ConversionException;
...
import org.gogoego.util.text.Replacer;
	...
	private Row rsToRow(final ResultSet rs) throws SQLException {
		...
		while (rs.next()) {
			...
			try {
				...
				GetOut.log("### DBSession Failure: Failed converting column with type " + type + " and name " + name);
			}
		}
		return row;
	}
