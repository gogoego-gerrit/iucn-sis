...
//	 */
//	public static boolean migrateOccurrenceData(Assessment data) {
...
//	}
//
//	public static boolean operateOn(Assessment data, String canonicalName) {
//		boolean writeback = false;
//
...
//				if (curSelected.getValue().size() == 4) { // This is already
//					// modded
//					writeback = false;
//					continue;
//				} else {
