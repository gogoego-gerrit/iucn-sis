...
public class ReferenceCitationGeneratorShared {
	...
	public static ReturnedCitation generateBookChapterCitation(Map<String, String> fields) {
	...
	public static ReturnedCitation generateBookCitation(Map<String, String> fields) {
	...
	private static ReturnedCitation generateCitation(Map<String, String> fields, String type) {
	...
	public static ReturnedCitation generateComputerProgramCitation(Map<String, String> fields) {
		ReturnedCitation returnedCitation = null;
		StringBuffer citation = new StringBuffer();
	...
	public static ReturnedCitation generateConferenceProceedingsCitation(Map<String, String> fields) {
		ReturnedCitation returnedCitation = null;
		StringBuffer citation = new StringBuffer();
	...
	public static ReturnedCitation generateEditedBookCitation(Map<String, String> fields) {
		ReturnedCitation returnedCitation = null;
		StringBuffer citation = new StringBuffer();
	...
	public static ReturnedCitation generateElectronicSourceCitation(Map<String, String> fields) {
		ReturnedCitation returnedCitation = null;
		StringBuffer citation = new StringBuffer();
	...
	public static ReturnedCitation generateJournalArticleCitation(Map<String, String> fields) {
	...
	public static ReturnedCitation generateMagazineCitation(Map<String, String> fields) {
		return generateJournalArticleCitation(fields);
	}

	public static ReturnedCitation generateManuscriptCitation(Map<String, String> fields) {
	 ...
	 */
	public static ReturnedCitation generateNewCitation(Map<String, String> fields, String type) {
		return generateCitation(fields, type);
	}

	public static ReturnedCitation generateNewspaperCitation(Map<String, String> fields) {
		return generateJournalArticleCitation(fields);
	}

	public static ReturnedCitation generateOtherCitation(Map<String, String> fields) {
		return generateBookCitation(fields);
	}
	...
	public static ReturnedCitation generateRLDBCitation(Map<String, String> fields) {
		ReturnedCitation returnedCitation = null;
	...
	public static ReturnedCitation generateThesisCitation(Map<String, String> fields) {
		ReturnedCitation returnedCitation = null;
		StringBuffer citation = new StringBuffer();
	...
	public static String getLabel(Map<String, String> fields, String labelName) {
