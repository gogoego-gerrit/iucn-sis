 ...
 * the License.
 */
package org.iucn.sis.client.panels.gwt;

import org.iucn.sis.client.panels.gwt.impl.RichTextAreaImpl;
...
public class RichTextArea extends FocusWidget implements HasHTML, SourcesMouseEvents {
	...
	private org.iucn.sis.client.panels.gwt.impl.RichTextAreaImpl impl = GWT.create(RichTextAreaImpl.class);
